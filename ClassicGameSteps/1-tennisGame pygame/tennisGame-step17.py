...
# Font for displaying text (You can customize this)
...
def draw_everything():
    ...
    # Display text (Replace "stuff" with actual score variables later)
    text = font.render("stuff", True, WHITE)
    screen.blit(text, (100, 100))  # Position the text
