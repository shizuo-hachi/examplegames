...
# Game functions
def ball_reset():
    global ball_speed_x  # Access global variable to modify it
...
while running:
    ...
    move_paddle(paddle2, mouse_pos)  # Move the right paddle (paddle2) with the mouse
    move_ball()
